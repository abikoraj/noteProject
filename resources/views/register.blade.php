...
<head>
    ...
    <meta name="description" content="Notes - Sign-Up">
        ...
        <div class="col-12 col-md-7 col-lg-6 auth-main-col text-center p-5">
            <div class="d-flex flex-column align-content-end">
                <div class="app-auth-body mx-auto">
                    ...
                    <h2 class="auth-heading text-center mb-4">Sign up to Notes</h2>

                    <div class="auth-form-container text-start mx-auto">
                        <form class="auth-form auth-signup-form">
                            <div class="email mb-3">
                                <label class="sr-only" for="signup-email">Your Name</label>
                                <input name="name" type="text" class="form-control signup-name" placeholder="Full name"
                                    required="required">
                            </div>
                            <div class="email mb-3">
                            ...
                            <div class="email mb-3">
                                ...
                                <input name="phone" type="email" class="form-control signup-email" placeholder="tel"
                                    required="required">
                            </div>
                        ...
                        <div class="auth-option text-center pt-5">Already have an account? <a class="text-link"
                                href="{{ route('admin.login') }}">Log in</a></div>
                    </div>
                    <!--//auth-form-container-->
